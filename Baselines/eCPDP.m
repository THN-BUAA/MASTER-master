function [PD, PF, UAC, MCC, Balance, F1, probPos] = eCPDP(sources, target, LOC)
...
%   (3) LOC     - Line-of-code metric of the target datasets;
%
% OUTPTS:
%   PD,PF,...
%
...
[ PD,PF,AUC,MCC,Balance,F1] = Performance(target(:,end), probPos); % Call self-defined function Performance()
